...
### USAGE!
### python parking_lot_trim_by_label.py --in /home/costar/Data/parking11oct/1920_1080/ --topics camera_right/color/image_raw
###
...
times = []
with open('parking_times.csv') as f: ## FOR SOME REASON, CAN'T READ CSV IN OTHER DIRECTORY
    csv_reader = csv.reader(f, delimiter = ',')
    # https://stackoverflow.com/questions/13428318/reading-rows-from-a-csv-file-in-python
    for i, line in enumerate(csv_reader):
        bag_name = line[0]+'_'+line[1]+'_'+line[2].split('.')[0]+'_'+line[3]+'.bag'
        out_bags.append(bag_name)
        times.append((float(line[4]), float(line[5])))
        # print 'Start bracket:', float(line[1]), " ", float(line[2])
